...
if [[ ${UNAME} == "Windows" ]]; then
	...
	alias backup-bookmarks="${MV} \"${HOME}/Desktop/data.\"*/bookmarks/bookmarks{,-$(date --iso)}.html ; ${SED} -i -e \"/^[[:space:]]+[<]DD[>]$/d\" -e \"s/<HR>([[:space:]])/<HR>\n\1/g\" \"${HOME}/Desktop/data.\"*/bookmarks/bookmarks-$(date --iso).html ; vdiff \"\`ls \"${HOME}/Desktop/data.\"*/bookmarks/bookmarks-*.html | tail -n2 | head -n1\`\" \"${HOME}/Desktop/data.\"*/bookmarks/bookmarks-$(date --iso).html"
