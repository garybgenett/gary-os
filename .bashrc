...
alias pim-mount="umount -f ${PIMDIR} ; mount -t cifs -o ro,username=plastic //10.255.255.254/plastic/_pim ${PIMDIR}"
...
function task-export {
	...
	gtasks_export.pl taskwarrior "Actions"		"$(task-filter "view")"			"due,9999"	"urgency"
