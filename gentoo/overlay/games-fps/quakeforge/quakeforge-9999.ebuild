...
#>>>	2021-08-08 12:31:29 +0900 2828500f0418ce49f14c5bc6585163729f72e7e1 [qfvis] Delay freeing of winding memory
	EGIT_COMMIT="2828500f0418ce49f14c5bc6585163729f72e7e1"
	KEYWORDS="~amd64 ~x86"
#>>>
else
	MY_COMMIT=""
...
src_configure() {
	...
	econf "${econfargs[@]}"
#>>>
	eapply -p0 "${FILESDIR}"/fix-missing-libqfsound.patch
#>>>
}
