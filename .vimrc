...
map <F6> <ESC>:set foldcolumn=0<CR>:set columns=80<CR>:set wrap<CR>:set nolist<CR>:set showbreak=<CR>
...
map <F12> <ESC>:set formatoptions-=a<CR><ESC>:set nospell<CR><ESC>:set noexpandtab<CR><ESC>:set shiftwidth=8<CR><ESC>:set tabstop=8<CR><ESC>:set textwidth=0 <CR>:source ${HOME}/.vimrc<CR>
